...
class Search extends Component {
 ...
 getCode2 = (e) => {
  e.preventDefault();
  let input = this.state.inputValue.replace(" ", "%20")
...
this.state.artist_albums.forEach((a,i) =>{
  ...
  this.state.album_tracks.forEach((a,i) =>{
    ...
    if ((this.state.playing) && (a.preview_url === this.state.song)) {
     control = <svg onClick={(e) => this.handlePauseSong()} width="25" height="26" viewBox="0 0 55 56" fill="none" xmlns="http://www.w3.org/2000/svg">
     <path d="M53.5 28C53.5 42.6611 41.834 54.5 27.5 54.5C13.166 54.5 1.5 42.6611 1.5 28C1.5 13.3389 13.166 1.5 27.5 1.5C41.834 1.5 53.5 13.3389 53.5 28Z" stroke="white" stroke-width="3"/>
...
this.state.artists.forEach((a, i) => {
  ...
  console.log(this.timeConverter(35000))
  console.log(<Token
